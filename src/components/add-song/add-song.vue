    ...
    <div class="add-song" v-show="showFlag" @click.stop>
      ...
      <div class="shortcut" v-show="!query">
        ...
        <div class="list-wrapper">
          ...
          <scroll :refreshDelay="refreshDelay" v-if="currentIndex===1" :data="searchHistory" class="list-scroll" ref= searchList>
            <div class="list-inner">
              <search-list @detele="deleteSearchHistory" @select="addQuery"
